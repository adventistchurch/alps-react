...
var Icon = function Icon(_ref) {
  var name = _ref.name,
      color = _ref.color;
  var Icn = icons[name];
  return Icn ? React__default.createElement(Icn, {
...
var Button = function Button(_ref) {
  ...
  return React__default.createElement(as, _objectSpread({
    href: url ? url : '#',
    className: classNames
  }, rest), React__default.createElement(React__default.Fragment, null, text, ' ', icon && React__default.createElement(IconWrap, {
    name: icon,
    className: iconClass,
    size: iconSize,
    fill: iconFill,
...
var Picture = function Picture(_ref2) {
  ...
  return React__default.createElement("picture", {
    className: "picture"
  }, React__default.createElement(Sources, {
    image: image
...
var ContentBlock = function ContentBlock(_ref) {
  ...
  }, imageSrcSet && React__default.createElement(MediaImage, {
    srcSet: imageSrcSet,
    alt: imageAlt,
    url: url
  }), React__default.createElement("h3", {
  ...
  }, React__default.createElement("strong", null, title)) : React__default.createElement("strong", null, title)), description && React__default.createElement("p", {
    className: "c-block__body text"
  }, description), category && React__default.createElement("span", {
    className: "c-block__meta u-theme--color--dark u-font--secondary--xs"
  }, category), descriptionMore ? React__default.createElement(React__default.Fragment, null, React__default.createElement("div", {
    className: "c-block__content"
  }, React__default.createElement("p", null, descriptionMore)), React__default.createElement("a", {
    href: "",
    className: "o-button o-button--outline o-button--expand js-toggle-parent"
  }, "\xA0")) : cta && url && React__default.createElement(Button, {
    as: "a",
    text: cta,
    url: url,
...
var ContentBlockExpand = function ContentBlockExpand(_ref) {
  ...
  }, React__default.createElement("em", null, kicker)), ' ', title), React__default.createElement("div", {
...
var GalleryBlock = function GalleryBlock(_ref) {
  ...
  return React__default.createElement("div", {
    ...
    className: "u-font--primary--s u-theme--color--darker"
  }, kicker && React__default.createElement(React__default.Fragment, null, React__default.createElement("span", {
    className: "u-theme--color--base"
  }, React__default.createElement("em", null, kicker)), ' '), title), imageSrcSet.length > 1 && React__default.createElement("button", {
    ...
    name: "plus"
  })))), imageSrcSet.length > 0 && React__default.createElement("div", {
  ...
  })), imageSrcSet.length > 1 && React__default.createElement("div", {
...
var MediaCallToAction = function MediaCallToAction(_ref) {
  ...
  return React__default.createElement("a", {
    ...
    href: url
  }, label, icon && React__default.createElement("span", {
...
var MediaBlock = function MediaBlock(_ref) {
  ...
  }), video && React__default.createElement(MediaVideo, {
    video: video
  }), React__default.createElement("div", {
  ...
  }, kicker && React__default.createElement(Kicker, {
    text: kicker,
    className: classes.kicker
  }), title && React__default.createElement(MediaTitle, {
    title: title,
    url: url,
    className: "".concat(classes.title, " ").concat(kicker ? 'u-space--zero' : '')
  }), description && React__default.createElement(MediaDescription, {
    description: description
  })), (category || datetime) && React__default.createElement("div", {
    className: "c-media-block__meta c-block__meta ".concat(classes.meta)
  }, category && React__default.createElement(Category, {
    category: category
  }), datetime && React__default.createElement(MediaDate, {
    datetime: datetime,
    dateFormat: dateFormat
  })), cta && url && React__default.createElement(MediaCallToAction, {
    label: cta,
    url: url,
    icon: ctaIcon
  }))));
...
var Carousel = function Carousel(_ref) {
  ...
  }, renderItems(slides, Slide)), showArrows && React__default.createElement("div", {
...
var Comment = function Comment(_ref) {
  ...
  return React__default.createElement("div", {
    ...
    href: ""
  }, "(Edit)"))), React__default.createElement("p", {
    className: "c-comment__content"
  }, text), replyUrl && React__default.createElement("div", {
...
var CommentForm = function CommentForm(_ref) {
  ...
  }, React__default.createElement("strong", null, title), ' ', React__default.createElement("small", null, React__default.createElement("a", {
    rel: "nofollow",
  ...
  }, "Cancel reply"))), React__default.createElement("form", {
    action: action,
    method: method,
...
var LoginForm = function LoginForm(_ref) {
  ...
  return React__default.createElement("form", {
    ...
    className: "u-font--secondary--m u-theme--color--darker"
  }, titleText), submitMessage && React__default.createElement("div", {
    className: "messaging u-padding u-color--white u-theme--background-color--darker"
  }, React__default.createElement("span", {
    className: "u-font--secondary--s"
  }, submitMessage)), React__default.createElement("input", {
    type: "text",
    name: "name",
...
var SearchForm = function SearchForm(_ref) {
  ...
  }, React__default.createElement("fieldset", null, React__default.createElement("legend", {
    className: "is-vishidden"
...
var SearchHeader = function SearchHeader(_ref) {
  ...
  }, "Media")), React__default.createElement("div", {
    className: "c-filter__form-item u-spacing--half l-grid-item l-grid-item--s--2-col l-grid-item--l--1-col"
  }, React__default.createElement("h3", {
    className: "u-font--secondary--s u-font-weight--bold u-text-transform--upper u-color--gray can-be--lighter"
...
function wrapMediaQuery(rule, query) {
  return "\n    ".concat(query ? "@media(".concat(query, ") {") : '', "\n      ").concat(rule, "\n    ").concat(query ? '}' : '', "\n    ");
} // returns a string of css rules wraped in queries for the provided media queries


function useResponsiveStyles(rule) {
  var data = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  var mediaQueries = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : [];
  var styles = Object.keys(mediaQueries).map(function (name) {
    var query = mediaQueries[name];
...
var mediaQueries = {
  ...
  large: 'min-width: 1200px' // Apply parallax effect to background images.
...
function useBackgroundParallax(element) {
  ...
  var _useState = React.useState(0),
      ...
      y = _useState2[0],
      setY = _useState2[1]; // event listener
  ...
  React.useEffect(function () {
    ...
    window.addEventListener('resize', listener); // Triggers listener for refresh

    listener(); // Clear listeners on component unmount
  ...
  return {
    backgroundPosition: "50% ".concat(y, "px")
  };
}
...
function BreakoutImage(_ref) {
  ...
  var backgroundStyles = parallax ? useBackgroundParallax(backgroundRef.current, // Element used to calculate the effect
  8, // Speed
  parallax // toggles parallax
  ) : {}; // get background image's styles

  var backgroundImageStyles = useResponsiveStyles(function (url) {
    return ".c-breakout-image__background {\n      background-image: url('".concat(url, "');\n    }");
  }, imageSrcSet, mediaQueries);
  return React__default.createElement("div", {
...
var Figure = function Figure(_ref) {
  ...
  }, imageSrcSet && React__default.createElement("div", {
...
var ArticleNavigation = function ArticleNavigation(_ref3) {
  ...
  }, dropdown.label, ' ', React__default.createElement("span", {
  ...
  }, renderItems(items, Item))), React__default.createElement("div", {
...
var AsideNavigation = function AsideNavigation(_ref3) {
  ...
  return (categoryItems.length > 0 || socialItems.length > 0) && React__default.createElement("nav", {
    className: "bg--tan aside-nav pad--secondary column__secondary can-be--dark-dark",
    id: "aside-nav"
  }, React__default.createElement("div", {
    className: "spacing"
  }, React__default.createElement(AsideList, {
    items: categoryItems
  }), categoryItems.length > 0 && React__default.createElement("hr", {
...
var Pullquote = function Pullquote(_ref) {
  ...
  }, React__default.createElement("p", null, text || children), author && React__default.createElement("cite", {
...
var ArticleContent = function ArticleContent(_ref) {
  var title = _ref.title,
      ...
      featured = _ref.featured,
      className = _ref.className;
  return React__default.createElement(React__default.Fragment, null, React__default.createElement("section", {
    ...
    className: "text c-article__body u-spacing--double"
  }, React__default.createElement("p", null, "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec malesuada, est ut viverra euismod, dui dolor gravida massa, sed aliquam ex nisl ut metus. Mauris at ante laoreet, gravida odio gravida, fermentum lectus. Fusce ac sollicitudin purus. Morbi et diam nunc. Praesent fringilla magna nisl, et volutpat nisi tincidunt aliquet. In laoreet ligula vel porttitor condimentum. In mattis ultricies placerat. Morbi interdum hendrerit tempus. Donec consequat elit vitae justo ornare, eget elementum quam consequat. Quisque auctor ex et congue finibus. Proin sed nisl ac velit aliquam euismod non tincidunt lectus. In enim ex, commodo feugiat porttitor sed, eleifend vitae ipsum. Suspendisse lorem nisl, suscipit at tellus quis, porttitor convallis sem."), React__default.createElement("p", null, "Vestibulum ipsum orci, egestas eu erat non, posuere maximus quam. Quisque tincidunt turpis id accumsan hendrerit. Cras eleifend, arcu sit amet faucibus blandit, dolor urna euismod sem, non molestie nulla nulla porta nibh. Integer commodo arcu vitae nisl iaculis, non hendrerit arcu sodales. Vivamus sagittis quam ut elit posuere ultrices. In blandit erat orci, vitae posuere enim vehicula quis. Nullam posuere mauris odio, eu facilisis lorem iaculis ut. Aenean tortor turpis, sollicitudin ut est eget, mattis feugiat arcu. Etiam est magna, aliquet ut blandit sit amet, malesuada a lacus. Nam scelerisque arcu non sem auctor molestie. Vestibulum sit amet congue ex."), React__default.createElement("p", null, "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec malesuada, est ut viverra euismod, dui dolor gravida massa, sed aliquam ex nisl ut metus. Mauris at ante laoreet, gravida odio gravida, fermentum lectus. Fusce ac sollicitudin purus. Morbi et diam nunc. Praesent fringilla magna nisl, et volutpat nisi tincidunt aliquet. In laoreet ligula vel porttitor condimentum. In mattis ultricies placerat. Morbi interdum hendrerit tempus. Donec consequat elit vitae justo ornare, eget elementum quam consequat. Quisque auctor ex et congue finibus. Proin sed nisl ac velit aliquam euismod non tincidunt lectus. In enim ex, commodo feugiat porttitor sed, eleifend vitae ipsum. Suspendisse lorem nisl, suscipit at tellus quis, porttitor convallis sem."), React__default.createElement("div", null))), React__default.createElement("div", {
...
var Footer = function Footer(_ref) {
  ...
  }, regionsText))))), React__default.createElement("div", {
  ...
  }, address)), React__default.createElement("div", {
...
var TopHat = function TopHat(_ref) {
  ...
  }, text, "\xA0", React__default.createElement("a", {
    className: "link--white",
    href: learnMore.url
  }, learnMore.text), "."));
};
...
var NavToggle = function NavToggle(_ref2) {
  ...
  }, renderTimes(4, Segment)), React__default.createElement("strong", {
...
var Item$1 = function Item(_ref2) {
  ...
  return React__default.createElement("li", _extends({
    ...
    href: url
  }, label), subpages && React__default.createElement(SubnavToggle, null), subpages && React__default.createElement("ul", {
...
var NavPrimary = function NavPrimary(_ref3) {
  ...
  }, items && React__default.createElement("ul", {
...
var Item$2 = function Item(_ref2) {
  ...
  }))), React__default.createElement("strong", null, label), "\xA0", React__default.createElement(If, {
    condition: subpages
  }, React__default.createElement("span", {
...
var Header = function Header(_ref) {
  ...
  return React__default.createElement("header", {
    ...
    role: "banner",
    id: "header"
  }, React__default.createElement(TopHat, null), React__default.createElement("div", {
    className: "header__inner"
  }, React__default.createElement(NavToggle, null), React__default.createElement("div", {
    className: "header__unify-logo-nav"
  }, React__default.createElement(LogoLink, _extends({}, logo, {
    isHoriz: true
  })), React__default.createElement(LogoLink, logo), React__default.createElement(NavPrimary, {
    items: primaryMenu
  })), React__default.createElement("div", {
    className: "header__utility"
  }, React__default.createElement("div", {
    className: "header__utility__inner full--until-large"
  }, React__default.createElement(NavSecondary, {
    items: secondaryMenu
  }), React__default.createElement(SearchForm, null)))));
};
...
var renderItems$1 = function renderItems(pages, currentPage, onPageClick) {
  return pages.map(function (page, key) {
    return page === currentPage ? React__default.createElement(CurrentItem, {
      label: currentPage,
      key: key
    }) : page === null ? React__default.createElement(Divider, {
      key: key
    }) : React__default.createElement(Item$3, {
      label: page,
...
var Pagination = function Pagination(_ref5) {
  ...
  }, renderItems$1(pages, currentPage, onPageClick)), React__default.createElement(Item$3, {
    next: nextPage,
    label: nextLabel,
    onClick: onNextClick
  }));
...
var PageHeader = function PageHeader(_ref) {
  var title = _ref.title,
      ...
      className = _ref.className;
  return React__default.createElement("header", {
    className: "header__swath theme--primary-background-color ".concat(heading ? ' header-swath--with-text' : '', " ").concat(logoSrc ? ' header-swath--with-image blend-mode--multiply' : '', " ").concat(className)
  }, React__default.createElement("div", {
    className: "layout-container cf"
  }, heading && React__default.createElement("div", {
    className: "header__text"
  }, React__default.createElement("div", {
    className: "unify show-at--small"
  }, React__default.createElement("h2", {
    className: "font--secondary--l upper white"
  }, heading), subhead && React__default.createElement("h3", {
    className: "font--secondary--m white--trans"
  }, subhead)), logoSrc && React__default.createElement("div", {
    className: "header__logo"
  }, React__default.createElement(Image, {
    src: logoSrc,
    alt: heading
  }))), React__default.createElement("div", {
    className: "flex-container cf"
  }, React__default.createElement("div", {
    className: "shift-left--fluid"
  }, kicker && React__default.createElement("span", {
    className: "kicker white"
  }, kicker), React__default.createElement("h1", {
    className: "font--tertiary--xl white"
  }, React__default.createElement("a", {
    className: "link--white link-hover--white",
    href: url
  }, title))), React__default.createElement("div", {
    className: "shift-right--fluid"
  }))));
};
...
var BasicPage = function BasicPage(_ref) {
  var title = _ref.title,
      ...
      aside = _ref.aside;
  var sectionClass = "l-main__content l-grid l-grid--7-col u-shift--left--1-col--at-".concat(breakout || aside ? 'xxlarge' : 'large', " l-grid-wrap--6-of-7 u-spacing--double--until-xxlarge u-padding--zero--sides");
  var articleClass = "c-article l-grid-item l-grid-item--l--4-col ".concat(breakout || aside ? 'l-grid-item--xl--3-col' : '');
  return React__default.createElement(React__default.Fragment, null, React__default.createElement("main", {
    ...
    breadcrumbs: breadcrumbs
  }, content))), (breakout || aside) && React__default.createElement("div", {
    className: "c-sidebar l-grid-item l-grid-item--l--2-col l-grid-item--xl--2-col u-spacing u-padding--zero--sides"
  }, breakout && React__default.createElement(BreakoutBlock, breakout), React__default.createElement(Aside, null, aside)))));
};
